...
public class ScreenSpaceOutlines : ScriptableRendererFeature {
    ...
    private class ScreenSpaceOutlinePass : ScriptableRenderPass {
        ...
        public ScreenSpaceOutlinePass(RenderPassEvent renderPassEvent, LayerMask layerMask,
            ...
            if (!settings.Outlines || !settings.ViewSpaceNormals)
            {
                Debug.LogError("Missing shaders for ScreenSpaceOutlines. Please assign them in the Renderer Feature settings.");
                return;
            }
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData) {
            // don't draw outlines on any camera that's not the main camera
